...
final class Version20260428133320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "categoria" (id UUID NOT NULL, nome VARCHAR(50) NOT NULL, descricao VARCHAR(255) DEFAULT NULL, icone_url VARCHAR(255) DEFAULT NULL, ordem INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4E10122D54BD530C ON "categoria" (nome)');
        $this->addSql('CREATE TABLE "cliente" (id UUID NOT NULL, cpf VARCHAR(11) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, anonymized_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, user_id UUID NOT NULL, PRIMARY KEY (id))');
